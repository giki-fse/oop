...
# Lab Manual: Pointers in C++

## Objective:
To understand and implement the concepts of pointers in C++ including pointer declaration, dereferencing, pointer arithmetic, and dynamic memory allocation.
